      ...
      <table class="w-full max-w-full border-collapse">
        ...
        <tr>
          ...
          <th class="left-[88px] bg-[#f4f6f8] sticky py-3.5 px-4 text-left font-550 whitespace-nowrap">
            ...
            <RouterLink :to="{ name : 'edit_customers', params: { id : selectedRows[0]}}" v-if="hasSelection" class="appearance-none static inline-flex justify-center items-center font-550">
              <span>Sửa</span>
            </RouterLink>
          </th>
          <th class="left-[88px] bg-[#f4f6f8] sticky py-3.5 px-4 text-left font-550 whitespace-nowrap">
        ...
        <tbody>
        <tr v-for="(item,index) in dataUsers" class="bg-white cursor-pointer border-t border-[#e8eaeb] hover:bg-color-30">
          ...
          <td class="text-left whitespace-nowrap py-2 px-4 max-w-[300px] text-ellipsis overflow-hidden">
            <span class="font-450 ">{{ item.username }}</span>
          </td>
          <td class="text-left whitespace-nowrap py-2 px-4 max-w-[300px] text-ellipsis overflow-hidden">
            <span class="font-450 ">{{ item.fullname }}</span>
          </td>
          <td class="text-left whitespace-nowrap py-2 px-4 max-w-[300px] text-ellipsis overflow-hidden">
            <span class="font-450 ">{{ item.email }}</span>
          </td>
          <td class="left-[88px] sticky py-2 px-4 text-left whitespace-nowrap">
            <RouterLink to="/" class="inline text-color-28">
              <div class="flex">
                <div class="w-fit">#</div>
                <div class="w-fit text-sm font-450">{{ item.roles[0].code}}</div>
              </div>
            </RouterLink>
          </td>
        </tr>
