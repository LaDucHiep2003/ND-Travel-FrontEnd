      ...
      <table class="w-full max-w-full border-collapse">
        ...
        <tr>
          ...
          <th class="left-[88px] bg-[#f4f6f8] sticky py-3.5 px-4 text-left font-550 whitespace-nowrap">
            ...
            <RouterLink :to="{ name : 'edit_collection', params: { id : selectedRows[0]}}" v-if="hasSelection" class="appearance-none static inline-flex justify-center items-center font-550">
              <span>Sửa</span>
            </RouterLink>
          </th>
          ...
          <th class="left-[88px] bg-[#f4f6f8] sticky py-3.5 px-4 text-left font-550 whitespace-nowrap">
            <button class="appearance-none static inline-flex justify-center items-center font-550">
              <span>Mô tả</span>
            </button>
          </th>
        </tr>
        ...
        <tbody>
        <tr v-for="(item,index) in dataCategories" class="bg-white cursor-pointer border-t border-[#e8eaeb] hover:bg-color-30">
          ...
          <td class="text-left whitespace-nowrap py-2 px-4 max-w-[300px] text-ellipsis overflow-hidden">
            <span class="font-450 ">{{ item.name }}</span>
          </td>
          <td class="text-left whitespace-nowrap py-2 px-4">
              <span class="max-w-32">
                <span class="block whitespace-nowrap overflow-ellipsis overflow-hidden font-450">10</span>
              </span>
          </td>
          <td class="text-left whitespace-nowrap py-2 px-4">
...
<script>
import {deleteCategory, getCategory} from "@/service/TourCategoryService.js";
