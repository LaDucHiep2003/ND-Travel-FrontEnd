  ...
  <div class="container mx-auto">
    <div class="py-4">
      <div class="flex justify-between flex-nowrap min-h-8">
        <div class="py-1.5 text-[22px] font-550">Tour đã khởi hàng</div>
    ...
    <div class="relative rounded-md bg-white overflow-clip css-onvepv h-screen" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 1px 3px 1px, rgba(0, 0, 0, 0.15) 0px 1px 2px 0px;
      ...
      <!--      Loc Don Hang-->
      <LocTour @search="handleSearch"  />
      <TableTour  :dataTours="dataTours" />
      <PhanTrang />
    </div>
  </div>
</template>
<script>
import LocTour from "@/pages/admin/LichTrinh/LocTour.vue";
import TableTour from "@/pages/admin/LichTrinh/TableTour.vue";
